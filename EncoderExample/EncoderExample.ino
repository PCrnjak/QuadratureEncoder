...
Encoders leftEncoder(PA2,PA3);	// Create an Encoder object name leftEncoder, using digitalpin 2 & 3
Encoders rightEncoder(PA5,PA4); // Encoder object name rightEncoder using analog pin A0 and A1 
